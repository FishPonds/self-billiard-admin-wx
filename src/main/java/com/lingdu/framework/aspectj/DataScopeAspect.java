...
public class DataScopeAspect
{
    ...
    {
        // 获取当前的用户
        SelfUser currentUser = ShiroUtils.getSelfUser();
        if (currentUser != null)
        {
            // 如果是超级管理员，则不过滤数据
     ...
     */
    public static void dataScopeFilter(JoinPoint joinPoint, SelfUser user, String deptAlias, String userAlias)
    {
        StringBuilder sqlString = new StringBuilder();

        for (SelfRole role : user.getRoles())
        {
            ...
            else if (DATA_SCOPE_SELF.equals(dataScope))
            {
                ...
                {
                    sqlString.append(StringUtils.format(" OR {}.user_id = {} ", userAlias, user.getSelfUserId()));
                }
                else
                {
